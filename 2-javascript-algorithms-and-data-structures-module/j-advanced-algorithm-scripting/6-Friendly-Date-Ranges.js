...
function friendly(str) {
  ...
  function monthDiff(date1, date2) {
    let month2 = date2.getUTCFullYear() * 12 + date2.getUTCMonth();
    let month1 = date1.getUTCFullYear() * 12 + date1.getUTCMonth();
  ...
  let date1 = convertDate(str[0]);
  let date2 = convertDate(str[1]);
