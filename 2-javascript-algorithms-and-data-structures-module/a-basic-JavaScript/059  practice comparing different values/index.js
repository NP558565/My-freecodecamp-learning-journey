...
:zap: If the values being compared are not of the same type, the equality
...
3 == "3"; // returns true because JavaScript performs type conversion from
 string to number
3 === "3"; // returns false because the types are different and type 
conversion is not performed
```
Note
In JavaScript, you can determine the type of a variable or a value with
...
The `compareEquality` function in the editor compares two values using 
the \__equality operator_. Modify the function so that it returns `"Equal"` 
