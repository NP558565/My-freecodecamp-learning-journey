...
the name of the item. The second element should be a number representing
 the quantity i.e.
...
myList.push(["Apple", 12]);
myList.push(["Milk", 2]);
myList.push(["Notebook", 6]);
myList.push(["Oranges", 12]);
myList.push(["Vegetables", 1]);
myList.push(["Banana", 12]);
