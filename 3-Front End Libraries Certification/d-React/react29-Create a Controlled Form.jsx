 ...
 * and textarea, which makes them controlled components.
 *
 ...
 *
 * You should then complete the handleSubmit method so that it sets the component state property submit to
 * the current input value in the local state.
 *
 * Note:  You also must call event.preventDefault() in the submit handler, to prevent the default
 * form submit behavior which will refresh the web page.
 *
 * Finally, create an h1 tag after the form which renders the submit value from the component's state.
 *
 * You can then type in the form and click the button (or press enter), and you should see your input
