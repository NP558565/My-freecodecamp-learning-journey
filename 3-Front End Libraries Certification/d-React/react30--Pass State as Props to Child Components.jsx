/**
 * You saw a lot of examples that passed props to child JSX elements and child React components
 ...
 * access to the user's username so it can display it.
 *
 * You pass that piece of state to the Navbar component as a prop.
 *
 * This pattern illustrates some important paradigms in React. The first is unidirectional data flow.
 *
 * State flows in one direction down the tree of your application's components, from the stateful parent
 * component to child components.
 *
 * The child components only receive the state data they need. The second is that complex stateful apps
 ...
 *
 * It begins to create a separation where state management is handled in one part of code and UI
 ...
 *
 * Pass the name property in its state down to the child component, then show the name in the h1
 * tag that's part of the Navbar render method.
 *
 */
