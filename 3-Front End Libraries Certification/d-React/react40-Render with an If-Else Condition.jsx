/**
 * Another application of using JavaScript to control your rendered view is to tie the elements that are
 * rendered to a condition.
 *
 ...
 *
 * Rewrite the render() method with an if/else statement so that if display is true, you return the
 * current markup.
 *
