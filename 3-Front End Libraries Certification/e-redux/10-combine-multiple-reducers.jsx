 ...
 * 
 * You define multiple reducers to handle different pieces of your application's state, then compose 
 * these reducers together into one root reducer. 
 * 
 * The root reducer is then passed into the Redux createStore() method.
 * 
 * In order to let us combine multiple reducers together, Redux provides the combineReducers() method.
 * 
 *  This method accepts an object as an argument in which you define properties which associate keys to 
 ...
 * are distinct or unique in some way. 
 * 
 ...
 * 
 * In this example, the state held in the Redux store would then be a single object containing 
 * auth and notes properties.
 * 
 * There are counterReducer() and authReducer() functions provided in the code editor, along with a 
 * Redux store. 
 * 
