/**
 * So far these challenges have avoided discussing asynchronous actions, but they are an unavoidable 
 * part of web development. 
 * 
 * At some point you'll need to call asynchronous endpoints in your Redux app, so how do you handle these 
 * types of requests? 
 * 
 ...
 * 
 * It's common to dispatch an action before initiating any asynchronous behavior so that your application 
 * state knows that some data is being requested (this state could display a loading icon, for instance). 
 * 
 * Then, once you receive the data, you dispatch another action which carries the data as a payload along 
 ...
 * 
 * This is what you'll use to dispatch your actions, you simply pass the action directly to dispatch 
 * and the middleware takes care of the rest.
 * 
 * Write both dispatches in the handleAsync() action creator. Dispatch requestingData() before the 
 * setTimeout() (the simulated API call). 
 * 
