/**
 * By now you've learned how to dispatch actions to the Redux store, but so far these actions have not 
 * contained any information other than a type. 
 * 
 * You can also send specific data along with your actions. 
 * 
 * In fact, this is very common because actions usually originate from some user interaction and tend to 
 * carry some data with them. 
 ...
 * 
 * The object should include a type property with a value of ADD_NOTE, and also a text property set 
 * to the note data that's passed into the action creator. 
 * 
 * When you call the action creator, you'll pass in specific note information that you can access for 
 * the object.
 * 
 ...
 * 
 * The action is dispatched at the bottom of the code. Once you're finished, run the code and watch 
 * the console. 
 * 
