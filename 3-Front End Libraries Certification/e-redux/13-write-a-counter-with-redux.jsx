/**
 * Now you've learned all the core principles of Redux! You've seen how to create actions and action
 * creators, create a Redux store, dispatch your actions against the store, and design state updates
 * with pure reducers.
 *
 ...
 *
 * The next challenges cover some of the details regarding state immutability, but first, here's a
 * review of everything you've learned so far.
 *
