 ...
 * 
 * Redux does not enforce state immutability, however, you are responsible for enforcing it in the code 
 * of your reducer functions. 
 * 
 ...
 * returns a state object with login set to true. 
 * 
