 ...
 * 
 * This is the first important principle to understand when learning Redux: the Redux store is the single 
 * source of truth when it comes to application state.
 * 
 ...
 * 
 * If you're not familiar with default arguments, you can refer to the ES6 section in the Curriculum which 
 * covers this topic.
 * 
 */
