 ...
 * 
 * The spread operator has a variety of applications, one of which is well-suited to the previous 
 * challenge of producing a new array from an existing array. 
 * 
 ...
 * 
 * The spread syntax can be used multiple times in array composition like this, but it's important to 
 * note that it only makes a shallow copy of the array. 
 * 
