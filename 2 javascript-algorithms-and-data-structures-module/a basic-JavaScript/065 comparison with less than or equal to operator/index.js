/*The less than or equal to operator (`<=`) compares the values of two numbers.
 ...
 the right, it returns `false`. Like the equality operator, less than or equal
  to converts data types.
...
"8" <= 4; // false
```
Add the `less than or equal to` operator to the indicated lines so 
