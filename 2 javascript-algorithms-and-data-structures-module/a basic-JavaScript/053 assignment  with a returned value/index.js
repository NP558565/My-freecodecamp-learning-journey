/*If you'll recall from our discussion of _Storing Values with the Assignment
 Operator_, everything to the right of the equal sign is resolved before the 
...
will call `sum` function, which returns a value of `17` and assigns it to
 `ourSum` variable.
