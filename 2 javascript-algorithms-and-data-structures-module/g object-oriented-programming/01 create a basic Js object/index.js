...
These qualities, or `properties`, define what makes up an object. Note that 
similar objects share the same properties, but may have different values for 
those properties. For example, all cars have wheels, but not all cars have the 
same number of wheels.

_Objects_ in JavaScript are used to model real-world objects, giving them 
...
```
This `duck` object has two property/value pairs: a `name` of "Aflac" and 
a `numLegs` of 2.
